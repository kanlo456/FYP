...
const getWorknote = async (req, res) => {
  ...
  if (!worknote) {
    return res
      .status(404)
      .json({ error: "No such worknote, can not find the worknote" });
  }
...
const createWorknote = async (req, res) => {
  ...
  const { notes, ticket_id } = req.body;
...
const deleteWorknote = async (req, res) => {
  ...
  if (!worknote) {
    return res
      .status(404)
      .json({ error: "No such worknote, can not delete the worknote" });
  }
  res.status(200).json(worknote);
};
...
const updateWorknote = async (req, res) => {
  ...
  if (!worknote) {
    return res
      .status(404)
      .json({ error: "No such worknote, can not update the worknote" });
  }
  res.status(200).json(worknote);
};
